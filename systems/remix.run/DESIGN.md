---
name: "Remix - The Fully-Stacked Web Framework"
category: Brands
surface: web
colors:
  background: "#ffffff"
  ...
  border: "#dbdbdb"
  accent: "#2dacf9"
  accent-secondary: "#7ce95a"
---

# Remix - The Fully-Stacked Web Framework
...
| accent | Accent | `#2dacf9` | primary brand color |
| accent-secondary | Accent secondary | `#7ce95a` | secondary brand color / links |
