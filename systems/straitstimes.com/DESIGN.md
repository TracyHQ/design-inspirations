...
| accent | Accent | `#264f88` | primary brand color |

## Typography
- **Display:** curator-tech-semibold — weights 400, 700 — fallbacks: system-ui, -apple-system, Segoe UI, Helvetica Neue, Arial, sans-serif
- **Body:** curator-tech-semibold — weights 400, 700 — fallbacks: system-ui, -apple-system, Segoe UI, Helvetica Neue, Arial, sans-serif
